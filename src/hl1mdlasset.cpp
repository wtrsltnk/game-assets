...
void Hl1MdlAsset::LoadTextures(std::vector<HlTexture*>& _textures)
{
...
void Hl1MdlAsset::LoadBodyParts(std::vector<HL1::tFace>& faces, std::vector<HlTexture*>& lightmaps, std::vector<HL1::tVertex>& _vertices)
{
    float s, t;
    int vertnum;
